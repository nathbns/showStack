...
__turbopack_context__.k.register(_c18, "GitHub");
...
_s(DroppableTrash, "DmJTTt6A5xWIX/faBiFge3FOLrw=", false, function() {
    return [
...
_s1(SortableTechCard, "nQIrknGhnk90kSmBL0zFOSuxMGI=", false, function() {
    return [
...
_s2(StripeCard, "iTIyvp0X9kMGpdHRsWsr2+tGbVI=", false, function() {
    return [
        __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$dnd$2d$kit$2f$sortable$2f$dist$2f$sortable$2e$esm$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useSortable"]
    ];
});
...
function Dashboard() {
    ...
    const [activeStack, setActiveStack] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(undefined);
    ...
    const [isConnectingStripe, setIsConnectingStripe] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(false);
    const [stripeAccountMrr, setStripeAccountMrr] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(null);
    const [isLoadingStripeAccountMrr, setIsLoadingStripeAccountMrr] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(false);
    const [isDisconnectingStripe, setIsDisconnectingStripe] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(false);
    const [showStripeInGrid, setShowStripeInGrid] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(false);
    ...
    const [fetchedGitHubStats, setFetchedGitHubStats] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])({});
    const [isStripeSuccessToastShown, setIsStripeSuccessToastShown] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(false);
    const [stripeCardColSpan, setStripeCardColSpan] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(2);
    const [stripeCardRowSpan, setStripeCardRowSpan] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(1);
    const [stripeCardDbId, setStripeCardDbId] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(null);
    const [gridItemOrder, setGridItemOrder] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])([]);
    ...
    const hydrateTechnologies = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "Dashboard.useCallback[hydrateTechnologies]": (rawTechs)=>{
            if (!rawTechs) return [];
            return rawTechs.filter({
                "Dashboard.useCallback[hydrateTechnologies]": (rawTech)=>rawTech.technologyId !== STRIPE_MRR_PSEUDO_TECH_ID
            }["Dashboard.useCallback[hydrateTechnologies]"]).map({
    ...
    }["Dashboard.useCallback[hydrateTechnologies]"], []); // iconMap et getDefaultIcon sont stables et définies hors du composant
    const saveActiveStack = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "Dashboard.useCallback[saveActiveStack]": async (stackToSave, showSuccessToast = true)=>{
            if (!session?.user?.id) {
                __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$sonner$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["toast"].error("You must be logged in to save.");
                return null;
            }
            if (!stackToSave) {
                __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$sonner$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["toast"].error("No active stack to save.");
                return null;
            }
            const itemsToSave = [];
            gridItemOrder.forEach({
                "Dashboard.useCallback[saveActiveStack]": (itemId, index)=>{
                    if (itemId === STRIPE_CARD_DND_ID) {
                        ...
                        const tech = stackToSave.technologies.find({
                            "Dashboard.useCallback[saveActiveStack].tech": (t)=>String(t.id) === String(itemId)
            ...
            try {
                ...
                const stripeItemFromApi = (savedStackData.technologies || []).find({
                    "Dashboard.useCallback[saveActiveStack].stripeItemFromApi": (t)=>t.technologyId === STRIPE_MRR_PSEUDO_TECH_ID
                }["Dashboard.useCallback[saveActiveStack].stripeItemFromApi"]);
                const regularTechsFromApi = (savedStackData.technologies || []).filter({
                    "Dashboard.useCallback[saveActiveStack].regularTechsFromApi": (t)=>t.technologyId !== STRIPE_MRR_PSEUDO_TECH_ID
                }["Dashboard.useCallback[saveActiveStack].regularTechsFromApi"]);
                ...
                setUserStacks({
                    "Dashboard.useCallback[saveActiveStack]": (prevStacks)=>prevStacks.map({
                            "Dashboard.useCallback[saveActiveStack]": (s)=>s.id === finalStack.id ? finalStack : s
                        }["Dashboard.useCallback[saveActiveStack]"])
                }["Dashboard.useCallback[saveActiveStack]"]);
                if (activeStackId === null && finalStack.id) setActiveStackId(finalStack.id);
                if (showSuccessToast) __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$sonner$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["toast"].success(`Stack '${finalStack.name}' saved successfully!`);
                return finalStack;
            } catch (error) {
                __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$sonner$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["toast"].error(error.message || "Unable to save the stack.");
                return null;
            }
        }
    }["Dashboard.useCallback[saveActiveStack]"], [
    ...
    const handleShowStripeCardInGrid = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "Dashboard.useCallback[handleShowStripeCardInGrid]": ()=>{
            ...
            setShowStripeInGrid(true);
            setGridItemOrder({
                "Dashboard.useCallback[handleShowStripeCardInGrid]": (prevOrder)=>prevOrder.includes(STRIPE_CARD_DND_ID) ? prevOrder : [
                        STRIPE_CARD_DND_ID,
                        ...prevOrder.filter({
                            "Dashboard.useCallback[handleShowStripeCardInGrid]": (id)=>id !== STRIPE_CARD_DND_ID
                        }["Dashboard.useCallback[handleShowStripeCardInGrid]"])
                    ]
            }["Dashboard.useCallback[handleShowStripeCardInGrid]"]);
            if (activeStack) {
    ...
    const handleFetchStripeAccountMrr = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "Dashboard.useCallback[handleFetchStripeAccountMrr]": async ()=>{
            ...
            try {
                ...
                if (!response.ok) {
                    const errorData = await response.json();
                    throw new Error(errorData.error || "Failed to fetch MRR");
                }
                const data = await response.json();
                setStripeAccountMrr(data);
                __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$sonner$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["toast"].success("Stripe MRR data fetched successfully!");
            } catch (error) {
                __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$sonner$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["toast"].error(error.message || "Could not fetch Stripe MRR.");
    ...
    const handleDisconnectStripe = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "Dashboard.useCallback[handleDisconnectStripe]": async ()=>{
            ...
            try {
                ...
                if (!response.ok) {
                    const errorData = await response.json();
                    throw new Error(errorData.error || "Failed to disconnect Stripe");
                }
                __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$sonner$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["toast"].success("Stripe account disconnected successfully.");
                setHasStripeConnection(false);
                setStripeAccountMrr(null);
                setShowStripeInGrid(false);
                setStripeCardDbId(null);
                setGridItemOrder({
                    "Dashboard.useCallback[handleDisconnectStripe]": (prevOrder)=>prevOrder.filter({
                            "Dashboard.useCallback[handleDisconnectStripe]": (id)=>id !== STRIPE_CARD_DND_ID
                ...
                __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$sonner$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["toast"].error(error.message || "Could not disconnect Stripe account.");
            } finally{
    ...
    const handleUpdateStripeCardSize = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "Dashboard.useCallback[handleUpdateStripeCardSize]": (updates)=>{
            let changed = false;
    ...
    }["Dashboard.useCallback[handleUpdateStripeCardSize]"], [
        activeStack,
        showStripeInGrid,
        stripeCardColSpan,
        stripeCardRowSpan,
    ...
    const handleUpdateTech = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "Dashboard.useCallback[handleUpdateTech]": (id, updates)=>{
            if (!activeStack) return;
            const updatedTechnologies = activeStack.technologies.map({
                "Dashboard.useCallback[handleUpdateTech].updatedTechnologies": (tech)=>tech.id === id ? {
                        ...tech,
                        ...updates
                    } : tech
            }["Dashboard.useCallback[handleUpdateTech].updatedTechnologies"]);
            const updatedStack = {
                ...activeStack,
                technologies: updatedTechnologies
            };
            setUserStacks({
                "Dashboard.useCallback[handleUpdateTech]": (prevStacks)=>prevStacks.map({
                        "Dashboard.useCallback[handleUpdateTech]": (s)=>s.id === activeStackId ? updatedStack : s
                    }["Dashboard.useCallback[handleUpdateTech]"])
            }["Dashboard.useCallback[handleUpdateTech]"]);
    ...
    const handleRemoveTech = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "Dashboard.useCallback[handleRemoveTech]": async (stackTechnologyItemId)=>{
            if (!activeStack) return;
            if (stackTechnologyItemId === STRIPE_CARD_DND_ID) {
            ...
            try {
                ...
                const updatedTechnologies = activeStack.technologies.filter({
                    "Dashboard.useCallback[handleRemoveTech].updatedTechnologies": (tech)=>tech.id !== stackTechnologyItemId
                }["Dashboard.useCallback[handleRemoveTech].updatedTechnologies"]);
                const updatedStack = {
                    ...activeStack,
                    technologies: updatedTechnologies
                };
                setUserStacks({
                    "Dashboard.useCallback[handleRemoveTech]": (prevStacks)=>prevStacks.map({
                            "Dashboard.useCallback[handleRemoveTech]": (s)=>s.id === activeStackId ? updatedStack : s
                        }["Dashboard.useCallback[handleRemoveTech]"])
                }["Dashboard.useCallback[handleRemoveTech]"]);
                setGridItemOrder({
                    "Dashboard.useCallback[handleRemoveTech]": (prev)=>prev.filter({
                            "Dashboard.useCallback[handleRemoveTech]": (id)=>id !== stackTechnologyItemId
                        }["Dashboard.useCallback[handleRemoveTech]"])
                }["Dashboard.useCallback[handleRemoveTech]"]);
        ...
        "Dashboard.useEffect": ()=>{
            if (activeStackId !== null && userStacks.length > 0) {
                const currentActiveStack = userStacks.find({
                    "Dashboard.useEffect.currentActiveStack": (stack)=>stack.id === activeStackId
                }["Dashboard.useEffect.currentActiveStack"]);
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "Dashboard.useEffect": ()=>{
            ...
            if (stripeSuccess && !isStripeSuccessToastShown) {
                ...
                newUrl = `/dashboard?${params.toString()}`;
            }
            if (stripeError) {
            ...
            const checkStripeStatus = {
                ...
                // ... (checkStripeStatus logic)
                }
            }["Dashboard.useEffect.checkStripeStatus"];
            if (!isLoadingSession && !stripeSuccess && !stripeError) checkStripeStatus();
        }
    }["Dashboard.useEffect"], [
        searchParams,
        router,
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "Dashboard.useEffect": ()=>{
            if (activeStack) {
                const techIds = activeStack.technologies.map({
                    "Dashboard.useEffect.techIds": (t)=>String(t.id)
                }["Dashboard.useEffect.techIds"]);
                let currentOrderFromStack = activeStack.technologies.slice().sort({
                    "Dashboard.useEffect.currentOrderFromStack": (a, b)=>(a.order || 0) - (b.order || 0)
                }["Dashboard.useEffect.currentOrderFromStack"]).map({
                    "Dashboard.useEffect.currentOrderFromStack": (t)=>String(t.id)
                }["Dashboard.useEffect.currentOrderFromStack"]);
                let newOrder = [
                    ...currentOrderFromStack
                ];
                const stripeItemInDb = activeStack.technologies.find({
                    "Dashboard.useEffect.stripeItemInDb": (t)=>t.technologyId === STRIPE_MRR_PSEUDO_TECH_ID
                }["Dashboard.useEffect.stripeItemInDb"]);
                if (showStripeInGrid) {
                    if (!newOrder.includes(STRIPE_CARD_DND_ID)) {
                        if (stripeItemInDb && typeof stripeItemInDb.order === "number") {
                            newOrder.splice(stripeItemInDb.order, 0, STRIPE_CARD_DND_ID);
                        } else {
                    ...
                    newOrder = newOrder.filter({
                        "Dashboard.useEffect": (id)=>id !== STRIPE_CARD_DND_ID
                    }["Dashboard.useEffect"]);
                }
                techIds.forEach({
                    "Dashboard.useEffect": (tid)=>{
                        if (!newOrder.includes(tid)) {
                            const stripeIdx = newOrder.indexOf(STRIPE_CARD_DND_ID);
                            if (stripeIdx !== -1 && stripeIdx < newOrder.length - 1) {
                                newOrder.splice(stripeIdx + 1, 0, tid);
                            } else {
                                newOrder.push(tid);
                            }
                        }
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "Dashboard.useEffect": ()=>{
            if (initialDataLoaded && activeStack && activeStack.technologies.length > 0) {
                activeStack.technologies.forEach({
                    "Dashboard.useEffect": (tech)=>{
                        ...
                        try {
                            ...
                            const hydratedStacks = stacksData.map({
                                "Dashboard.useEffect.fetchUserStacks.hydratedStacks": (stack)=>{
                                    const stripeItemInStack = (stack.technologies || []).find({
                                        "Dashboard.useEffect.fetchUserStacks.hydratedStacks.stripeItemInStack": (tech)=>tech.technologyId === STRIPE_MRR_PSEUDO_TECH_ID
                                    }["Dashboard.useEffect.fetchUserStacks.hydratedStacks.stripeItemInStack"]);
                                    const regularTechs = (stack.technologies || []).filter({
                                        "Dashboard.useEffect.fetchUserStacks.hydratedStacks.regularTechs": (tech)=>tech.technologyId !== STRIPE_MRR_PSEUDO_TECH_ID
                                    }["Dashboard.useEffect.fetchUserStacks.hydratedStacks.regularTechs"]);
    ...
    const handleDragEnd = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "Dashboard.useCallback[handleDragEnd]": (event)=>{
            ...
            if (over && active.id !== over.id) {
                ...
                if (oldIndex !== -1 && newIndex !== -1) {
                    const newOrderedGridItems = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$dnd$2d$kit$2f$sortable$2f$dist$2f$sortable$2e$esm$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["arrayMove"])(gridItemOrder, oldIndex, newIndex);
    ...
    }["Dashboard.useCallback[handleDragEnd]"], [
        gridItemOrder,
        activeStack,
        handleDisconnectStripe,
        handleRemoveTech,
    ...
    const handleAddTech = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "Dashboard.useCallback[handleAddTech]": async (newTechFromForm)=>{
            if (!activeStack) {
            ...
            if (savedStack) {
                setUserStacks({
                    "Dashboard.useCallback[handleAddTech]": (prevStacks)=>prevStacks.map({
                            "Dashboard.useCallback[handleAddTech]": (s)=>s.id === savedStack.id ? {
                                    ...savedStack
                                } : s
                        }["Dashboard.useCallback[handleAddTech]"])
                }["Dashboard.useCallback[handleAddTech]"]);
            }
        }
    }["Dashboard.useCallback[handleAddTech]"], [
    ...
    const handleReorderTechs = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "Dashboard.useCallback[handleReorderTechs]": (reorderedTechs)=>{
            if (!activeStack) return;
            const updatedStack = {
                ...activeStack,
            ...
            setUserStacks({
                "Dashboard.useCallback[handleReorderTechs]": (prevStacks)=>prevStacks.map({
                        "Dashboard.useCallback[handleReorderTechs]": (s)=>s.id === activeStackId ? updatedStack : s
                    }["Dashboard.useCallback[handleReorderTechs]"])
            }["Dashboard.useCallback[handleReorderTechs]"]);
            saveActiveStack(updatedStack, false);
        }
    }["Dashboard.useCallback[handleReorderTechs]"], [
    ...
    const handleActiveStackNameChange = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "Dashboard.useCallback[handleActiveStackNameChange]": (newName)=>{
            if (!activeStack || activeStack.name === newName) return;
            const updatedStack = {
                ...activeStack,
                name: newName
            };
            setUserStacks({
                "Dashboard.useCallback[handleActiveStackNameChange]": (prevStacks)=>prevStacks.map({
                        "Dashboard.useCallback[handleActiveStackNameChange]": (s)=>s.id === activeStackId ? updatedStack : s
                    }["Dashboard.useCallback[handleActiveStackNameChange]"])
            }["Dashboard.useCallback[handleActiveStackNameChange]"]);
            saveActiveStack(updatedStack, false);
        }
    }["Dashboard.useCallback[handleActiveStackNameChange]"], [
    ...
    const handleProfileDescriptionChange = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "Dashboard.useCallback[handleProfileDescriptionChange]": async (newDescription)=>{
    ...
    }["Dashboard.useCallback[handleProfileDescriptionChange]"], [
        session?.user?.id
    ]);
    const handleCreateNewStack = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "Dashboard.useCallback[handleCreateNewStack]": async (stackName)=>{
            if (!session?.user?.id) {
            ...
            try {
                ...
                setUserStacks({
                    "Dashboard.useCallback[handleCreateNewStack]": (prevStacks)=>[
                            ...prevStacks,
                            hydratedNewStack
                        ]
                }["Dashboard.useCallback[handleCreateNewStack]"]);
    ...
    const handleDeleteStack = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "Dashboard.useCallback[handleDeleteStack]": async (stackIdToDelete)=>{
            if (!session?.user?.id) {
            ...
            setStackToDelete(stackIdToDelete);
            setIsDeleteDialogOpen(true);
        }
    }["Dashboard.useCallback[handleDeleteStack]"], [
        session?.user?.id
    ]);
    const confirmDeleteStack = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "Dashboard.useCallback[confirmDeleteStack]": async ()=>{
            ...
            try {
                ...
                const updatedStacks = userStacks.filter({
                    "Dashboard.useCallback[confirmDeleteStack].updatedStacks": (stack)=>stack.id !== stackToDelete
                }["Dashboard.useCallback[confirmDeleteStack].updatedStacks"]);
                setUserStacks(updatedStacks);
                if (activeStackId === stackToDelete) setActiveStackId(updatedStacks.length > 0 ? updatedStacks[0].id : null);
    ...
    }["Dashboard.useCallback[confirmDeleteStack]"], [
        stackToDelete,
        userStacks,
        activeStackId
    ]);
...
_s3(Dashboard, "p1I2RxPovs9Qb1btqZ3fXeyoMg4=", false, function() {
    return [
...
//# sourceMappingURL=_3697c58c._.js.map