...
function SignInForm() {
    ...
    const handleLoginSocial = async (provider)=>{
        ...
        try {
            ...
            __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$sonner$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["toast"].success(`Attempting to sign in with ${provider}...`);
        } catch (error) {
...
_s(SignInForm, "hEgPA+W7UbIKa6VcFJFLjNzvKtk=", false, function() {
    return [
...
//# sourceMappingURL=_edcd593b._.js.map