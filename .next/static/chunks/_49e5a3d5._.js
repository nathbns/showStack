...
function SortableItem({ id, tech }) {
    ...
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
        ref: setNodeRef,
        style: style,
        className: `p-1 rounded-lg border-2 transition-all ${isDragging ? "border-primary shadow-lg bg-card/50" : "border-transparent"}`,
...
function TechStackGrid({ technologies, onRemoveTech, onUpdateTech, onReorderTechs }) {
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "TechStackGrid.useEffect": ()=>{
            // S'assurer que les items ont un ordre initial et sont triés
            ...
            console.log("TechStackGrid useEffect: Technologies prop updated, re-sorting and setting items:", JSON.parse(JSON.stringify(orderedTechnologies.map({
                "TechStackGrid.useEffect": (t)=>({
                        id: t.id,
                        name: t.name,
                        order: t.order
                    })
    ...
    const handleDragEnd = (event)=>{
        ...
        if (over && active.id !== over.id) {
            // It's important to use the `items` from the outer scope for findIndex before setItems,
            // or ensure `currentItemsInternal` is correctly sourced if used for these initial indices.
            ...
            console.log(`TechStackGrid handleDragEnd: Attempting to move item from oldIndex: ${oldIndex} to newIndex: ${newIndex}`);
            console.log("TechStackGrid handleDragEnd: Active item ID:", active.id, "Over item ID:", over.id);
            console.log("TechStackGrid handleDragEnd: Current items before move (snapshot):", JSON.parse(JSON.stringify(items.map((t)=>({
                    id: t.id,
                    name: t.name,
                    order: t.order
                })))));
            if (oldIndex === -1 || newIndex === -1) {
                console.error("TechStackGrid handleDragEnd: Could not find old or new index for items.", {
                    activeId: active.id,
                    overId: over.id,
                    oldIndex,
                    newIndex,
            ...
            setItems((currentItemsInternal)=>{
                const oldIndexInternal = currentItemsInternal.findIndex((item)=>String(item.id) === String(active.id));
                const newIndexInternal = currentItemsInternal.findIndex((item)=>String(item.id) === String(over.id));
                if (oldIndexInternal === -1 || newIndexInternal === -1) {
                    console.error("TechStackGrid handleDragEnd (inside setItems): Could not find old or new index.", {
                        activeId: active.id,
                        overId: over.id,
                        oldIndexInternal,
                        newIndexInternal
                    });
                    return currentItemsInternal;
                }
                console.log(`TechStackGrid handleDragEnd (inside setItems): Moving from oldIndexInternal: ${oldIndexInternal} to newIndexInternal: ${newIndexInternal}`);
                const reordered = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$dnd$2d$kit$2f$sortable$2f$dist$2f$sortable$2e$esm$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["arrayMove"])(currentItemsInternal, oldIndexInternal, newIndexInternal);
                const finalItems = reordered.map((item, index)=>({
                        ...item,
                        order: index
                    }));
                console.log("TechStackGrid handleDragEnd: Items after local reorder (order property updated):", JSON.parse(JSON.stringify(finalItems.map((t)=>({
                        id: t.id,
                        name: t.name,
                        order: t.order
                    })))));
                if (onReorderTechs) {
                    onReorderTechs(finalItems);
                }
                return finalItems;
            });
        }
    ...
    // Affichage normal de la grille (trié par 'order')
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
        className: "space-y-4",
        children: [
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
...
_s1(TechStackGrid, "0pAFamyiNUPEMU9ltqrspz3+Rt4=", false, function() {
    return [
...
__turbopack_context__.k.register(_c1, "TechStackGrid");
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(module, globalThis.$RefreshHelpers$);
}
}}),
    ...
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$components$2f$ui$2f$dialog$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Dialog"], {
        ...
        children: [
            ...
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$components$2f$ui$2f$dialog$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["DialogContent"], {
                className: "w-[95%] max-w-[500px] bg-background border-[var(--border)] text-[var(--foreground)] p-0 overflow-hidden",
                children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                            ...
                            children: [
                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                    ...
                                    children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$components$2f$ui$2f$tabs$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["TabsList"], {
                                        className: "grid grid-cols-2 w-full my-3",
                                        children: [
                                            ...
                                            children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("form", {
                                                ...
                                                children: [
                                                    ...
                                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$components$2f$ui$2f$button$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Button"], {
                                                        ...
                                                        children: isSubmitting ? "Ajout en cours..." : "Ajouter le projet"
                                                    }, void 0, false, {
                                                        fileName: "[project]/components/tech-stack/add-tech-form.tsx",
                                                        lineNumber: 399,
                                                        columnNumber: 19
...
_s(AddTechForm, "nqyGQwzygB2hWpbkJ6puWuEnDqU=");
_c = AddTechForm;
var _c;
...
function Dashboard() {
    ...
    const hydrateTechnologies = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "Dashboard.useCallback[hydrateTechnologies]": (rawTechs)=>{
            console.log("Dashboard hydrateTechnologies: Raw tech data for hydration:", JSON.parse(JSON.stringify(rawTechs.map({
                "Dashboard.useCallback[hydrateTechnologies]": (t)=>({
                        id: t.id,
                        name: t.name,
                        order: t.order
                    })
            ...
            if (!rawTechs) return [];
            const hydrated = rawTechs.map({
                "Dashboard.useCallback[hydrateTechnologies].hydrated": (rawTech, index)=>{
                    let icon;
                    let isProject = false;
            ...
            }["Dashboard.useCallback[hydrateTechnologies].hydrated"]);
            console.log("Dashboard hydrateTechnologies: All hydrated technologies:", JSON.parse(JSON.stringify(hydrated.map({
                "Dashboard.useCallback[hydrateTechnologies]": (t)=>({
                        id: t.id,
                        name: t.name,
                        order: t.order
    ...
    const saveActiveStack = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "Dashboard.useCallback[saveActiveStack]": async (stackToSave)=>{
            ...
            console.log("Dashboard saveActiveStack: Stack being prepared for API:", JSON.parse(JSON.stringify(stackToSave.technologies.map({
                "Dashboard.useCallback[saveActiveStack]": (t)=>({
                        id: t.id,
                        name: t.name,
                        order: t.order
                    })
            ...
            try {
                    ...
                    "Dashboard.useCallback[saveActiveStack].technologiesToSave": (tech, index)=>{
                        ...
                        const apiTechItem = {
                            ...
                            technologyId: tech.technologyId || __TURBOPACK__imported__module__$5b$project$5d2f$components$2f$tech$2d$stack$2f$tech$2d$data$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["allTechnologies"].find({
                                "Dashboard.useCallback[saveActiveStack].technologiesToSave": (t)=>t.id.toLowerCase() === tech.id.toLowerCase() // This seems problematic if tech.id is a DB id
                ...
                console.log("Dashboard saveActiveStack: Raw technologies from API response:", JSON.parse(JSON.stringify(savedStackData.technologies.map({
                    "Dashboard.useCallback[saveActiveStack]": (t)=>({
                            id: t.id,
                            name: t.name,
                            order: t.order
                ...
                console.log("Dashboard saveActiveStack: Technologies hydrated from API:", JSON.parse(JSON.stringify(hydratedFromApi.map({
                    "Dashboard.useCallback[saveActiveStack]": (t)=>({
                            id: t.id,
                            name: t.name,
                            order: t.order
...
//# sourceMappingURL=_49e5a3d5._.js.map