...
_c1 = DragOverlayItem;
function TechStackGrid({ technologies, onRemoveTech, onUpdateTech, onReorderTechs, readOnly = false }) {
    _s1();
...
function Dashboard() {
    ...
    const ProfileSection = ({ currentSessionData, isEditing, setIsEditing, currentDescription, editingDesc, setEditingDesc, onDescriptionChange })=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
            className: "relative bg-[var(--card)] p-6 rounded-lg border-1 border-[var(--border)] flex flex-col gap-6 h-full",
            children: [
                        ...
                        onClick: async ()=>{
                            if (confirm("Are you sure you want to delete your account? This action is irreversible and all your data will be lost.")) {
                                try {
                                    ...
                                    if (response.ok) {
                                        __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$sonner$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["toast"].success("Account deleted successfully. Redirecting...");
                                        ...
                                        const errorData = await response.json();
                                        __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$sonner$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["toast"].error(errorData.error || "Failed to delete account.");
                                    }
                                } catch (error) {
                                    console.error("Error calling delete account API:", error);
                                    __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$sonner$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["toast"].error("An error occurred while deleting the account.");
                                }
                            }
                        },
                        className: "w-full",
    ...
    const StacksSection = ({ userStacks, activeStackId, handleCreateNewStack, setActiveStackId, handleDeleteStack, saveActiveStack })=>{
        _s();
    ...
    _s(StacksSection, "iEYviHCJXqr/rxvP+SpzgvyJcbo=");
...
_s2(Dashboard, "RGgfSmgZVCdE5+H2GDLYH5MwiBk=", false, function() {
    return [
