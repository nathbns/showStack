...
function Dashboard() {
    ...
    }["Dashboard.useCallback[handleFetchStripeAccountMrr]"], []); // Pas de dépendances externes dynamiques
    ...
    const handleRemoveTech = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "Dashboard.useCallback[handleRemoveTech]": async (stackTechnologyItemId)=>{
            ...
            try {
                ...
                }["Dashboard.useCallback[handleRemoveTech]"]); // Mettre à jour aussi gridItemOrder
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "Dashboard.useEffect": ()=>{
            if (activeStack) {
                ...
                const stripeTechFromStack = activeStack.technologies.find({
                    "Dashboard.useEffect.stripeTechFromStack": (t)=>t.technologyId === STRIPE_MRR_PSEUDO_TECH_ID
                }["Dashboard.useEffect.stripeTechFromStack"]);
                ...
                newOrder = uniqueItems.sort({
                    "Dashboard.useEffect": (a, b)=>{
    ...
    const sensors = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$dnd$2d$kit$2f$core$2f$dist$2f$core$2e$esm$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useSensors"])();
...
_s3(Dashboard, "qAraC/WW96DaCQTfsEDJwhUrTh0=", false, function() {
    return [
...
//# sourceMappingURL=_495a8482._.js.map