...
var __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$auth$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/lib/auth.ts [app-route] (ecmascript)"); // Supposant que auth() retourne la session/utilisateur
...
async function getDecryptedAccessToken(encryptedToken) {
    ...
    console.warn(" avertissement de sécurité: le token d'accès Stripe n'est pas déchiffré.");
...
async function GET(request) {
    try {
        ...
        const userStripeConnection = await __TURBOPACK__imported__module__$5b$project$5d2f$drizzle$2f$db$2f$index$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["db"].select().from(__TURBOPACK__imported__module__$5b$project$5d2f$drizzle$2f$db$2f$schema$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["stripeConnection"]).where((0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$drizzle$2d$orm$2f$sql$2f$expressions$2f$conditions$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["eq"])(__TURBOPACK__imported__module__$5b$project$5d2f$drizzle$2f$db$2f$schema$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["stripeConnection"].userId, userId)).limit(1);
        ...
        if (!platformStripeSecretKey) {
            ...
            return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
                error: "Configuration Stripe incomplète côté serveur (secret plateforme)."
            }, {
                status: 500
            });
        }
        ...
        const { total, currency } = calculateMrrFromSubscriptions(subscriptions.data);
...
//# sourceMappingURL=%5Broot-of-the-server%5D__9a0fb441._.js.map