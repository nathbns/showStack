...
"[project]/.next-internal/server/app/api/user/avatar/route/actions.js [app-rsc] (server actions loader, ecmascript)": (function(__turbopack_context__) {
...
"[project]/app/api/user/avatar/route.ts [app-route] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
const AVATARS_DIR = __TURBOPACK__imported__module__$5b$externals$5d2f$path__$5b$external$5d$__$28$path$2c$__cjs$29$__["default"].join(process.cwd(), "public", AVATARS_BASE_PATH);
// S'assurer que le répertoire des avatars existe au démarrage
(0, __TURBOPACK__imported__module__$5b$externals$5d2f$fs$2f$promises__$5b$external$5d$__$28$fs$2f$promises$2c$__cjs$29$__["mkdir"])(AVATARS_DIR, {
    recursive: true
}).catch(console.error);
async function POST(req) {
    ...
    try {
        ...
        const fileExtension = __TURBOPACK__imported__module__$5b$externals$5d2f$path__$5b$external$5d$__$28$path$2c$__cjs$29$__["default"].extname(file.name) || ".png"; // Default to .png if no extension
        const filename = `${(0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$uuid$2f$dist$2f$esm$2f$v4$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$export__default__as__v4$3e$__["v4"])()}${fileExtension}`;
        const userAvatarDir = __TURBOPACK__imported__module__$5b$externals$5d2f$path__$5b$external$5d$__$28$path$2c$__cjs$29$__["default"].join(AVATARS_DIR, userId);
        const filePath = __TURBOPACK__imported__module__$5b$externals$5d2f$path__$5b$external$5d$__$28$path$2c$__cjs$29$__["default"].join(userAvatarDir, filename);
        const publicFilePath = __TURBOPACK__imported__module__$5b$externals$5d2f$path__$5b$external$5d$__$28$path$2c$__cjs$29$__["default"].join(AVATARS_BASE_PATH, userId, filename); // Chemin public pour l'URL
        // Créer le répertoire spécifique à l'utilisateur s'il n'existe pas
        await (0, __TURBOPACK__imported__module__$5b$externals$5d2f$fs$2f$promises__$5b$external$5d$__$28$fs$2f$promises$2c$__cjs$29$__["mkdir"])(userAvatarDir, {
            recursive: true
        });
        ...
        const currentUserDetails = await __TURBOPACK__imported__module__$5b$project$5d2f$drizzle$2f$db$2f$index$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["db"].query.user.findFirst({
        ...
        if (currentUserDetails?.image && currentUserDetails.image.startsWith(AVATARS_BASE_PATH)) {
            const oldFilename = __TURBOPACK__imported__module__$5b$externals$5d2f$path__$5b$external$5d$__$28$path$2c$__cjs$29$__["default"].basename(currentUserDetails.image);
            const oldUserAvatarPath = __TURBOPACK__imported__module__$5b$externals$5d2f$path__$5b$external$5d$__$28$path$2c$__cjs$29$__["default"].join(AVATARS_DIR, userId, oldFilename);
            try {
                await (0, __TURBOPACK__imported__module__$5b$externals$5d2f$fs$2f$promises__$5b$external$5d$__$28$fs$2f$promises$2c$__cjs$29$__["unlink"])(oldUserAvatarPath);
                console.log("Ancienne image supprimée:", oldUserAvatarPath);
            } catch (err) {
                console.error("Erreur lors de la suppression de l'ancienne image (non bloquant):", err);
...
async function DELETE(req) {
    ...
    try {
        ...
        if (currentUserDetails.image.startsWith(AVATARS_BASE_PATH)) {
            const filename = __TURBOPACK__imported__module__$5b$externals$5d2f$path__$5b$external$5d$__$28$path$2c$__cjs$29$__["default"].basename(currentUserDetails.image);
            const userAvatarPath = __TURBOPACK__imported__module__$5b$externals$5d2f$path__$5b$external$5d$__$28$path$2c$__cjs$29$__["default"].join(AVATARS_DIR, userId, filename);
            try {
                await (0, __TURBOPACK__imported__module__$5b$externals$5d2f$fs$2f$promises__$5b$external$5d$__$28$fs$2f$promises$2c$__cjs$29$__["unlink"])(userAvatarPath);
                console.log("Image supprimée du système de fichiers:", userAvatarPath);
            } catch (err) {
                console.error("Erreur lors de la suppression de l'image du système de fichiers (non bloquant):", err);
...
//# sourceMappingURL=%5Broot-of-the-server%5D__1a757536._.js.map