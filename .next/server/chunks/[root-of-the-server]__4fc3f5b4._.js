...
"[project]/.next-internal/server/app/api/user/layout/route/actions.js [app-rsc] (server actions loader, ecmascript)": (function(__turbopack_context__) {
...
"[project]/app/api/user/layout/route.ts [app-route] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$auth$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/lib/auth.ts [app-route] (ecmascript)"); // Assurez-vous que authOptions est bien exporté depuis ce chemin
(()=>{
...
async function GET(request) {
    const session = await getServerSession(__TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$auth$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["authOptions"]);
    if (!session?.user?.id) {
    ...
    try {
        ...
        if (user && user.dashboardLayout) {
            // Assurez-vous que le type correspond. Prisma stocke JSON comme `JsonValue`.
            return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json(user.dashboardLayout);
        } else {
            // Si aucune disposition n'est trouvée, retourner null.
            // Le client décidera d'utiliser localStorage ou une valeur par défaut.
...
async function PUT(request) {
    ...
    try {
        ...
        // Validation simple du format du layout
        if (!layout || typeof layout.zoneLeft !== "string" || typeof layout.zoneTopRight !== "string" || layout.zoneLeft !== "profile" && layout.zoneLeft !== "stacks" || layout.zoneTopRight !== "profile" && layout.zoneTopRight !== "stacks" || layout.zoneLeft === layout.zoneTopRight) {
            return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
...
//# sourceMappingURL=%5Broot-of-the-server%5D__4fc3f5b4._.js.map