...
"[project]/.next-internal/server/app/api/profile/[username]/route/actions.js [app-rsc] (server actions loader, ecmascript)": (function(__turbopack_context__) {
...
async function GET(request, { params } // Paramètres destructurés directement
) {
    ...
    try {
        ...
        const userStacksWithPossibleStripeCard = await Promise.all(userStacksFromDb.map(async (stack)=>{
            let technologiesFromStack = stack.technologies.map((tech)=>({
                    ...tech,
                    id: String(tech.id),
            ...
            if (stack.showStripeCard) {
                ...
                if (hasStripeConnection) {
                    const fetchedMrr = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$stripe$2d$mrr$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["fetchMrrForUser"])(userInfoFromDb.id);
                    if (fetchedMrr) {
            ...
            technologiesFromStack.sort((a, b)=>(a.order ?? Infinity) - (b.order ?? Infinity));
            return {
                ...stack,
...
//# sourceMappingURL=%5Broot-of-the-server%5D__18c582c0._.js.map