...
"[project]/.next-internal/server/app/api/user/delete/route/actions.js [app-rsc] (server actions loader, ecmascript)": (function(__turbopack_context__) {
    ...
    socialProviders: {
        github: {
            ...
            mapProfileToUser: async (profile)=>{
                ...
                const existingUser = await __TURBOPACK__imported__module__$5b$project$5d2f$drizzle$2f$db$2f$index$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["db"].query.user.findFirst({
                    where: (user, { eq })=>eq(user.email, profile.email)
                });
                if (!existingUser) {
                    throw new Error("Vous devez d'abord créer un compte avant de vous connecter avec GitHub");
                }
                if (profile.bio) {
                    setTimeout(async ()=>{
                        try {
        ...
        twitter: {
            ...
            mapProfileToUser: async (profile)=>{
                ...
                if (!existingUser) {
                    throw new Error("Vous devez d'abord créer un compte avant de vous connecter avec Twitter");
                }
                const customData = {};
...
var __TURBOPACK__imported__module__$5b$project$5d2f$drizzle$2f$db$2f$schema$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/drizzle/db/schema.ts [app-route] (ecmascript)"); // Uniquement besoin de 'user' grâce à onDelete: "cascade"
...
//# sourceMappingURL=%5Broot-of-the-server%5D__dd3aeabe._.js.map