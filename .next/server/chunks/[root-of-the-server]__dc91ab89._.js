...
"[project]/.next-internal/server/app/api/stripe/oauth/callback/route/actions.js [app-rsc] (server actions loader, ecmascript)": (function(__turbopack_context__) {
...
"[project]/app/api/stripe/oauth/callback/route.ts [app-route] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
([__TURBOPACK__imported__module__$5b$project$5d2f$drizzle$2f$db$2f$index$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$auth$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__] = __turbopack_async_dependencies__.then ? (await __turbopack_async_dependencies__)() : __turbopack_async_dependencies__);
;
;
;
;
...
async function GET(request) {
    ...
    if (errorParam) {
        ...
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].redirect(dashboardUrl.toString());
    }
    if (!code) {
        dashboardUrl.searchParams.set("stripe_error", "Aucun code d'autorisation fourni par Stripe.");
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].redirect(dashboardUrl.toString());
    }
    try {
        ...
        if (!session || !session.user || !session.user.id) {
            ...
            loginUrl.searchParams.set("error", "Session invalide lors du callback Stripe.");
            return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].redirect(loginUrl.toString());
        }
        const userId = session.user.id;
        const { STRIPE_SECRET_KEY } = process.env;
        if (!STRIPE_SECRET_KEY) {
            console.error("Clé secrète Stripe non configurée.");
            dashboardUrl.searchParams.set("stripe_error", "Configuration Stripe incomplète côté serveur (secret).");
            return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].redirect(dashboardUrl.toString());
        }
        ...
        const { access_token, refresh_token, stripe_user_id, scope, livemode, stripe_publishable_key } = response;
        ...
        const accessTokenExpiresAt = expiresInNum && !isNaN(expiresInNum) ? new Date(Date.now() + expiresInNum * 1000) : null;
        if (!access_token || !stripe_user_id) {
            console.error("Token d'accès ou ID utilisateur Stripe manquant dans la réponse OAuth.");
            dashboardUrl.searchParams.set("stripe_error", "Réponse OAuth invalide de Stripe.");
            return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].redirect(dashboardUrl.toString());
        }
        await __TURBOPACK__imported__module__$5b$project$5d2f$drizzle$2f$db$2f$index$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["db"].insert(__TURBOPACK__imported__module__$5b$project$5d2f$drizzle$2f$db$2f$schema$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["stripeConnection"]).values({
            userId: userId,
            ...
            target: __TURBOPACK__imported__module__$5b$project$5d2f$drizzle$2f$db$2f$schema$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["stripeConnection"].userId,
            set: {
                stripeUserId: stripe_user_id,
                accessToken: access_token,
                refreshToken: refresh_token || null,
        ...
        if (err instanceof __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$stripe$2f$esm$2f$stripe$2e$esm$2e$node$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].errors.StripeError) {
            // Essayer d'obtenir un message d'erreur plus spécifique de Stripe
            const rawError = err.raw; // Type assertion pour raw
            errorMessage = rawError?.message || err.message || "Erreur Stripe inconnue.";
...
//# sourceMappingURL=%5Broot-of-the-server%5D__dc91ab89._.js.map