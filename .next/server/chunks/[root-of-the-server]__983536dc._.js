...
"[project]/.next-internal/server/app/api/profile/username/[username]/route/actions.js [app-rsc] (server actions loader, ecmascript)": (function(__turbopack_context__) {
...
"[project]/drizzle/db/schema.ts [app-route] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
__turbopack_context__.s({
    ...
    "userStackTechnologies": (()=>userStackTechnologies),
    "userStackTechnologiesRelations": (()=>userStackTechnologiesRelations),
...
const userStackTechnologies = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$drizzle$2d$orm$2f$pg$2d$core$2f$table$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["pgTable"])("user_stack_technology", {
    id: (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$drizzle$2d$orm$2f$pg$2d$core$2f$columns$2f$text$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["text"])("id").primaryKey(),
    userId: (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$drizzle$2d$orm$2f$pg$2d$core$2f$columns$2f$text$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["text"])("user_id").notNull().references(()=>user.id, {
        onDelete: "cascade"
    }),
    name: (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$drizzle$2d$orm$2f$pg$2d$core$2f$columns$2f$text$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["text"])("name").notNull(),
    version: (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$drizzle$2d$orm$2f$pg$2d$core$2f$columns$2f$text$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["text"])("version"),
    description: (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$drizzle$2d$orm$2f$pg$2d$core$2f$columns$2f$text$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["text"])("description"),
...
const stackTechnologyItem = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$drizzle$2d$orm$2f$pg$2d$core$2f$table$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["pgTable"])("stack_technology_item", {
    id: (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$drizzle$2d$orm$2f$pg$2d$core$2f$columns$2f$serial$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["serial"])("id").primaryKey(),
    techStackId: (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$drizzle$2d$orm$2f$pg$2d$core$2f$columns$2f$integer$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["integer"])("tech_stack_id").notNull().references(()=>techStack.id, {
        onDelete: "cascade"
    }),
...
const stackTechnologyItemRelations = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$drizzle$2d$orm$2f$relations$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["relations"])(stackTechnologyItem, ({ one })=>({
        techStack: one(techStack, {
            fields: [
                stackTechnologyItem.techStackId
            ],
            references: [
                techStack.id
            ]
...
var __TURBOPACK__imported__module__$5b$project$5d2f$drizzle$2f$db$2f$schema$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/drizzle/db/schema.ts [app-route] (ecmascript)");
...
if (!process.env.DATABASE_URL) {
    throw new Error("DATABASE_URL environment variable is not set or accessible.");
}
...
const db = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$drizzle$2d$orm$2f$node$2d$postgres$2f$driver$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["drizzle"])(pool, {
    schema: __TURBOPACK__imported__module__$5b$project$5d2f$drizzle$2f$db$2f$schema$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__
});
__turbopack_async_result__();
...
"[project]/lib/stripe-mrr.ts [app-route] (ecmascript)": ((__turbopack_context__) => {
"use strict";

var { g: global, __dirname, a: __turbopack_async_module__ } = __turbopack_context__;
__turbopack_async_module__(async (__turbopack_handle_async_dependencies__, __turbopack_async_result__) => { try {
__turbopack_context__.s({
    "fetchMrrForUser": (()=>fetchMrrForUser)
});
var __TURBOPACK__imported__module__$5b$project$5d2f$drizzle$2f$db$2f$index$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/drizzle/db/index.ts [app-route] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$drizzle$2f$db$2f$schema$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/drizzle/db/schema.ts [app-route] (ecmascript)");
...
var __turbopack_async_dependencies__ = __turbopack_handle_async_dependencies__([
    __TURBOPACK__imported__module__$5b$project$5d2f$drizzle$2f$db$2f$index$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__
]);
([__TURBOPACK__imported__module__$5b$project$5d2f$drizzle$2f$db$2f$index$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__] = __turbopack_async_dependencies__.then ? (await __turbopack_async_dependencies__)() : __turbopack_async_dependencies__);
;
;
;
;
...
function calculateMrrFromSubscriptions(subscriptions) {
    let totalMrr = 0;
    let currency = null;
...
async function fetchMrrForUser(userId) {
    try {
        // 1. Récupérer la connexion Stripe de l'utilisateur depuis la table stripeConnection
        const userStripeConn = await __TURBOPACK__imported__module__$5b$project$5d2f$drizzle$2f$db$2f$index$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["db"].query.stripeConnection.findFirst({
            where: (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$drizzle$2d$orm$2f$sql$2f$expressions$2f$conditions$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["eq"])(__TURBOPACK__imported__module__$5b$project$5d2f$drizzle$2f$db$2f$schema$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["stripeConnection"].userId, userId),
            columns: {
        ...
        if (!userStripeConn || !userStripeConn.stripeUserId) {
            console.warn(`[fetchMrrForUser] Connexion Stripe (stripeUserId) non trouvée pour l'utilisateur ${userId}. Impossible de calculer le MRR.`);
            return {
                total: 0,
                currency: "USD"
            }; // Retourner 0 si pas de connexion
        }
        ...
        if (!platformStripeSecretKey) {
            console.error("[fetchMrrForUser] La variable d'environnement STRIPE_SECRET_KEY n'est pas configurée.");
            throw new Error("Configuration Stripe incomplète côté serveur.");
        }
        const stripe = new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$stripe$2f$esm$2f$stripe$2e$esm$2e$node$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"](platformStripeSecretKey, {
            typescript: true
        });
        ...
        const subscriptions = await stripe.subscriptions.list({
            ...
            stripeAccount: userStripeConn.stripeUserId
        } // Crucial: effectuer la requête AU NOM du compte connecté
        );
        // 4. Calculer le MRR
        return calculateMrrFromSubscriptions(subscriptions.data);
    } catch (error) {
        console.error(`[fetchMrrForUser] Erreur lors de la récupération du MRR pour l'utilisateur ${userId}:`, error);
...
"[project]/app/api/profile/username/[username]/route.ts [app-route] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$stripe$2d$mrr$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/lib/stripe-mrr.ts [app-route] (ecmascript)");
var __turbopack_async_dependencies__ = __turbopack_handle_async_dependencies__([
    __TURBOPACK__imported__module__$5b$project$5d2f$drizzle$2f$db$2f$index$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__,
    __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$stripe$2d$mrr$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__
]);
([__TURBOPACK__imported__module__$5b$project$5d2f$drizzle$2f$db$2f$index$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$stripe$2d$mrr$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__] = __turbopack_async_dependencies__.then ? (await __turbopack_async_dependencies__)() : __turbopack_async_dependencies__);
;
;
;
;
...
async function GET(request, context) {
    ...
    try {
        // 1. Récupérer les informations de l'utilisateur par son nom d'utilisateur
        const userInfoFromDb = await __TURBOPACK__imported__module__$5b$project$5d2f$drizzle$2f$db$2f$index$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["db"].query.user.findFirst({
            where: (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$drizzle$2d$orm$2f$sql$2f$expressions$2f$conditions$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["eq"])(__TURBOPACK__imported__module__$5b$project$5d2f$drizzle$2f$db$2f$schema$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["user"].username, username),
            columns: {
                id: true,
                name: true,
                username: true,
        ...
        // 2. Récupérer la stack de l'utilisateur
        const userStacks = await __TURBOPACK__imported__module__$5b$project$5d2f$drizzle$2f$db$2f$index$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["db"].query.techStack.findMany({
            where: (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$drizzle$2d$orm$2f$sql$2f$expressions$2f$conditions$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["eq"])(__TURBOPACK__imported__module__$5b$project$5d2f$drizzle$2f$db$2f$schema$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["techStack"].userId, userInfoFromDb.id),
            columns: {
                id: true
            },
            with: {
                technologies: {
                    ...
                    orderBy: [
                        (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$drizzle$2d$orm$2f$sql$2f$expressions$2f$select$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["asc"])(__TURBOPACK__imported__module__$5b$project$5d2f$drizzle$2f$db$2f$schema$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["stackTechnologyItem"].order)
                    ]
                }
            }
        });
        // 3. Vérifier si l'utilisateur a une connexion Stripe
        const stripeConnectionInfo = await __TURBOPACK__imported__module__$5b$project$5d2f$drizzle$2f$db$2f$index$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["db"].query.stripeConnection.findFirst({
            where: (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$drizzle$2d$orm$2f$sql$2f$expressions$2f$conditions$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["eq"])(__TURBOPACK__imported__module__$5b$project$5d2f$drizzle$2f$db$2f$schema$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["stripeConnection"].userId, userInfoFromDb.id),
            columns: {
                id: true,
                stripeUserId: true
        ...
        const hasStripeConnection = !!stripeConnectionInfo;
        // 4. Si l'utilisateur a une connexion Stripe, récupérer le MRR
        let stripeAccountMrr = null;
        if (hasStripeConnection) {
            try {
                stripeAccountMrr = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$stripe$2d$mrr$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["fetchMrrForUser"])(userInfoFromDb.id);
            } catch (error) {
                console.error("Error fetching MRR:", error);
            }
        }
        // 5. Préparer les données pour la réponse
        const userStack = userStacks.length > 0 ? userStacks[0] : null;
        // Préparer les technologies pour la réponse
        let technologies = [];
        if (userStack) {
            technologies = userStack.technologies.map((tech)=>({
                    ...tech,
                    isStripeCard: tech.technologyId === STRIPE_CARD_ID
                }));
            // Si l'utilisateur a une connexion Stripe et un MRR, ajouter ces informations à la carte Stripe
            if (hasStripeConnection && stripeAccountMrr) {
                const stripeCardIndex = technologies.findIndex((tech)=>tech.technologyId === STRIPE_CARD_ID);
                if (stripeCardIndex !== -1) {
                    technologies[stripeCardIndex] = {
                        ...technologies[stripeCardIndex],
                        mrr: stripeAccountMrr.total,
                        mrrCurrency: stripeAccountMrr.currency
                    };
                }
            }
        }
        // Incrémenter le compteur de partage
        await __TURBOPACK__imported__module__$5b$project$5d2f$drizzle$2f$db$2f$index$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["db"].update(__TURBOPACK__imported__module__$5b$project$5d2f$drizzle$2f$db$2f$schema$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["user"]).set({
            shareCount: (userInfoFromDb.shareCount || 0) + 1
        }).where((0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$drizzle$2d$orm$2f$sql$2f$expressions$2f$conditions$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["eq"])(__TURBOPACK__imported__module__$5b$project$5d2f$drizzle$2f$db$2f$schema$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["user"].id, userInfoFromDb.id));
        // 6. Retourner les données
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
            user: {
                ...userInfoFromDb,
                // Ne pas inclure l'email pour des raisons de confidentialité
                email: undefined
            },
            stack: userStack ? {
                id: userStack.id,
...
//# sourceMappingURL=%5Broot-of-the-server%5D__983536dc._.js.map