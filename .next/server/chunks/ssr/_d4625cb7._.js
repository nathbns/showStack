                        ...
                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                            ...
                            children: [
                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                    ...
                                    children: typeof icon === "string" ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("img", {
                                        src: icon,
                                        alt: name,
    ...
    Frontend: [
        {
            ...
            name: "TypeScript",
            color: "#3178C6",
            icon: "https://svgl.app/typescript.svg",
            category: "Frontend"
        },
        {
            id: "javascript",
            name: "JavaScript",
            color: "#F7DF1E",
            icon: "REMPLACER_PAR_URL_SVGL_JAVASCRIPT",
            category: "Frontend"
        },
        {
            id: "vue",
            name: "Vue.js",
            color: "#41B883",
            icon: "REMPLACER_PAR_URL_SVGL_VUEJS",
            category: "Frontend"
        },
        {
            id: "angular",
            name: "Angular",
            color: "#DD0031",
            icon: "REMPLACER_PAR_URL_SVGL_ANGULAR",
            category: "Frontend"
        },
        {
            id: "svelte",
            name: "Svelte",
            color: "#FF3E00",
            icon: "REMPLACER_PAR_URL_SVGL_SVELTE",
            category: "Frontend"
        },
        {
            id: "nextjs",
            name: "Next.js",
            color: "#000000",
            icon: "REMPLACER_PAR_URL_SVGL_NEXTJS",
            category: "Frontend"
        },
        {
            id: "nuxt",
            name: "Nuxt.js",
            color: "#00DC82",
            icon: "REMPLACER_PAR_URL_SVGL_NUXTJS",
            category: "Frontend"
        },
        {
            id: "tailwind",
            name: "Tailwind CSS",
            color: "#38B2AC",
            icon: "REMPLACER_PAR_URL_SVGL_TAILWINDCSS",
            category: "Frontend"
        },
        {
            id: "styled",
            ...
            color: "#DB7093",
            icon: "REMPLACER_PAR_URL_SVGL_STYLEDCOMPONENTS",
            category: "Frontend"
        },
        {
            id: "redux",
            name: "Redux",
            color: "#764ABC",
            icon: "REMPLACER_PAR_URL_SVGL_REDUX",
            category: "Frontend"
        }
    ],
    Backend: [
        {
            ...
            name: "Node.js",
            color: "#539E43",
            icon: "REMPLACER_PAR_URL_SVGL_NODEJS",
            category: "Backend"
        },
        {
            id: "express",
            name: "Express",
            color: "#000000",
            icon: "REMPLACER_PAR_URL_SVGL_EXPRESS",
            category: "Backend"
        },
        {
            id: "nestjs",
            name: "NestJS",
            color: "#E0234E",
            icon: "REMPLACER_PAR_URL_SVGL_NESTJS",
            category: "Backend"
        },
        {
            id: "graphql",
            name: "GraphQL",
            color: "#E535AB",
            icon: "REMPLACER_PAR_URL_SVGL_GRAPHQL",
            category: "Backend"
        },
        {
            id: "prisma",
            name: "Prisma",
            color: "#2D3748",
            icon: "REMPLACER_PAR_URL_SVGL_PRISMA",
            category: "Backend"
        },
        {
            id: "django",
            name: "Django",
            color: "#092E20",
            icon: "REMPLACER_PAR_URL_SVGL_DJANGO",
            category: "Backend"
        },
        {
            id: "laravel",
            name: "Laravel",
            color: "#FF2D20",
            icon: "REMPLACER_PAR_URL_SVGL_LARAVEL",
            category: "Backend"
        },
        {
            id: "spring",
            name: "Spring",
            color: "#6DB33F",
            icon: "REMPLACER_PAR_URL_SVGL_SPRING",
            category: "Backend"
        },
        {
            id: "flask",
            name: "Flask",
            color: "#000000",
            icon: "REMPLACER_PAR_URL_SVGL_FLASK",
            category: "Backend"
        },
        {
            id: "fastapi",
            name: "FastAPI",
            color: "#009688",
            icon: "REMPLACER_PAR_URL_SVGL_FASTAPI",
            category: "Backend"
        }
    ],
    Mobile: [
        {
            ...
            name: "Flutter",
            color: "#02569B",
            icon: "REMPLACER_PAR_URL_SVGL_FLUTTER",
            category: "Mobile"
        },
        {
            id: "kotlin",
            name: "Kotlin",
            color: "#7F52FF",
            icon: "REMPLACER_PAR_URL_SVGL_KOTLIN",
            category: "Mobile"
        },
        {
            id: "swift",
            name: "Swift",
            color: "#F05138",
            icon: "REMPLACER_PAR_URL_SVGL_SWIFT",
            category: "Mobile"
        },
        {
            id: "expo",
            name: "Expo",
            color: "#000020",
            icon: "REMPLACER_PAR_URL_SVGL_EXPO",
            category: "Mobile"
        }
    ],
    "Base de données": [
        {
            ...
            name: "MongoDB",
            color: "#47A248",
            icon: "REMPLACER_PAR_URL_SVGL_MONGODB",
        ...
        },
        {
            ...
            name: "PostgreSQL",
            color: "#336791",
            icon: "REMPLACER_PAR_URL_SVGL_POSTGRESQL",
            category: "Base de données"
        },
        {
            id: "mysql",
            name: "MySQL",
            color: "#4479A1",
            icon: "REMPLACER_PAR_URL_SVGL_MYSQL",
            category: "Base de données"
        },
        {
            id: "redis",
            name: "Redis",
            color: "#DC382D",
            icon: "REMPLACER_PAR_URL_SVGL_REDIS",
            category: "Base de données"
        },
        {
            id: "firebase",
            name: "Firebase",
            color: "#FFCA28",
            icon: "REMPLACER_PAR_URL_SVGL_FIREBASE",
            category: "Base de données"
        },
        {
            id: "supabase",
            name: "Supabase",
            color: "#3ECF8E",
            icon: "REMPLACER_PAR_URL_SVGL_SUPABASE",
            category: "Base de données"
        },
        {
            id: "dynamodb",
            name: "DynamoDB",
            color: "#4053D6",
            icon: "REMPLACER_PAR_URL_SVGL_DYNAMODB",
            category: "Base de données"
        }
    ],
    "DevOps & Cloud": [
        {
            ...
            name: "Docker",
            color: "#2496ED",
            icon: "REMPLACER_PAR_URL_SVGL_DOCKER",
        ...
        },
        {
            ...
            name: "Kubernetes",
            color: "#326CE5",
            icon: "REMPLACER_PAR_URL_SVGL_KUBERNETES",
            category: "DevOps & Cloud"
        },
        {
            id: "aws",
            name: "AWS",
            color: "#FF9900",
            icon: "REMPLACER_PAR_URL_SVGL_AWS",
            category: "DevOps & Cloud"
        },
        {
            id: "gcp",
            name: "Google Cloud",
            color: "#4285F4",
            icon: "REMPLACER_PAR_URL_SVGL_GCP",
            category: "DevOps & Cloud"
        },
        {
            id: "azure",
            name: "Azure",
            color: "#0078D4",
            icon: "REMPLACER_PAR_URL_SVGL_AZURE",
            category: "DevOps & Cloud"
        },
        {
            id: "vercel",
            name: "Vercel",
            color: "#000000",
            icon: "REMPLACER_PAR_URL_SVGL_VERCEL",
            category: "DevOps & Cloud"
        },
        {
            id: "netlify",
            name: "Netlify",
            color: "#00C7B7",
            icon: "REMPLACER_PAR_URL_SVGL_NETLIFY",
            category: "DevOps & Cloud"
        },
        {
            id: "github",
            name: "GitHub Actions",
            color: "#2088FF",
            icon: "REMPLACER_PAR_URL_SVGL_GITHUBACTIONS",
            category: "DevOps & Cloud"
        },
        {
            id: "gitlab",
            name: "GitLab CI",
            color: "#FC6D26",
            icon: "REMPLACER_PAR_URL_SVGL_GITLABCI",
            category: "DevOps & Cloud"
        },
        {
            id: "terraform",
            name: "Terraform",
            color: "#7B42BC",
            icon: "REMPLACER_PAR_URL_SVGL_TERRAFORM",
            category: "DevOps & Cloud"
        }
    ],
    "Tests & Outils": [
        {
            ...
            name: "Jest",
            color: "#C21325",
            icon: "REMPLACER_PAR_URL_SVGL_JEST",
        ...
        },
        {
            ...
            name: "Cypress",
            color: "#17202C",
            icon: "REMPLACER_PAR_URL_SVGL_CYPRESS",
            category: "Tests & Outils"
        },
        {
            id: "playwright",
            name: "Playwright",
            color: "#2EAD33",
            icon: "REMPLACER_PAR_URL_SVGL_PLAYWRIGHT",
            category: "Tests & Outils"
        },
        {
            id: "storybook",
            name: "Storybook",
            color: "#FF4785",
            icon: "REMPLACER_PAR_URL_SVGL_STORYBOOK",
            category: "Tests & Outils"
        },
        {
            id: "webpack",
            name: "Webpack",
            color: "#8DD6F9",
            icon: "REMPLACER_PAR_URL_SVGL_WEBPACK",
            category: "Tests & Outils"
        },
        {
            id: "vite",
            name: "Vite",
            color: "#646CFF",
            icon: "REMPLACER_PAR_URL_SVGL_VITE",
            category: "Tests & Outils"
        },
        {
            id: "eslint",
            name: "ESLint",
            color: "#4B32C3",
            icon: "REMPLACER_PAR_URL_SVGL_ESLINT",
            category: "Tests & Outils"
        },
        {
            id: "prettier",
            name: "Prettier",
            color: "#F7B93E",
            icon: "REMPLACER_PAR_URL_SVGL_PRETTIER",
            category: "Tests & Outils"
        },
        {
            id: "git",
            name: "Git",
            color: "#F05032",
            icon: "REMPLACER_PAR_URL_SVGL_GIT",
            category: "Tests & Outils"
        }
    ]
};
                        ...
                        children: [
                            ...
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                ...
                                children: [
                                    ...
                                    activeStack && technologies.length === 0 && !isLoadingInitialData && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
...
//# sourceMappingURL=_d4625cb7._.js.map