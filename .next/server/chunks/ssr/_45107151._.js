...
function Dashboard() {
    ...
    const handleAddTech = async (newTechFromForm)=>{
        ...
        if (savedStack) {
            setActiveStack(savedStack); // Mettre à jour avec les données du serveur (peut inclure ID, etc.)
            ...
            __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$sonner$2f$dist$2f$index$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["toast"].error("Failed to save the new technology, please try again.");
        }
    };
...
//# sourceMappingURL=_45107151._.js.map