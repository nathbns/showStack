...
function TechStackGrid({ technologies, onRemoveTech, onUpdateTech, onReorderTechs }) {
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useEffect"])(()=>{
        ...
        console.log("TechStackGrid useEffect: Technologies prop updated, re-sorting and setting items:", JSON.parse(JSON.stringify(orderedTechnologies.map((t)=>({
                id: t.id,
                name: t.name,
                order: t.order
            })))));
    ...
    const handleDragEnd = (event)=>{
        ...
        if (over && active.id !== over.id) {
            ...
            setItems((currentItemsInternal)=>{
                ...
                const reordered = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$dnd$2d$kit$2f$sortable$2f$dist$2f$sortable$2e$esm$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["arrayMove"])(currentItemsInternal, oldIndexInternal, newIndexInternal);
        ...
        try {
            const technologiesToSave = stackToSave.technologies.map((tech, index)=>{
                ...
                const apiTechItem = {
                    ...
                    name: tech.name,
                    color: tech.color,
                    technologyId: tech.technologyId || __TURBOPACK__imported__module__$5b$project$5d2f$components$2f$tech$2d$stack$2f$tech$2d$data$2e$tsx__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["allTechnologies"].find((t)=>t.id.toLowerCase() === tech.id.toLowerCase() // This seems problematic if tech.id is a DB id
                    )?.id || tech.id,
...
//# sourceMappingURL=_1f436fc7._.js.map