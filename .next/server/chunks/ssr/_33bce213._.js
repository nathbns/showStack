...
function Dashboard() {
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useEffect"])(()=>{
        const checkStripeStatus = async ()=>{
            ...
            try {
                ...
                __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$sonner$2f$dist$2f$index$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["toast"].error("Failed to check Stripe connection status.");
                setHasStripeConnection(false);
            } finally{
    ...
    const saveUserStack = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useCallback"])(async (stackToSave, showSuccessToast = true)=>{
        ...
        if (!stackToSave) {
            __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$sonner$2f$dist$2f$index$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["toast"].error("Aucune grille à sauvegarder.");
            return null;
        }
        ...
        try {
            ...
            if (!response.ok) {
                ...
                throw new Error(errorData.error || "Erreur lors de la sauvegarde de la grille");
            }
            ...
            if (showSuccessToast) {
                __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$sonner$2f$dist$2f$index$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["toast"].success("Grille sauvegardée avec succès !");
            }
            return finalStack;
        } catch (error) {
            __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$sonner$2f$dist$2f$index$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["toast"].error(error.message || "Impossible de sauvegarder la grille.");
            return null;
        }
    }, [
        session,
            ...
            if (session?.user?.id) {
                ...
                try {
                    ...
                    if (stackData) {
                        ...
                        try {
                            ...
                            if (createResponse.ok) {
                                ...
                                console.error("[ERROR] Échec de création de la stack par défaut");
                                __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$sonner$2f$dist$2f$index$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["toast"].error("Impossible de créer votre grille.");
                            }
                        } catch (createError) {
                            console.error("[ERROR] Exception lors de la création de la stack:", createError);
                            __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$sonner$2f$dist$2f$index$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["toast"].error("Erreur lors de la création de votre grille.");
                        }
                    }
                } catch (error) {
                    console.error("[ERROR] Impossible de charger la grille:", error);
                    __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$sonner$2f$dist$2f$index$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["toast"].error("Impossible de charger votre grille.");
                    ...
                    try {
                        ...
                        console.error("[ERROR] Échec de la tentative de récupération:", createError);
    ...
    const handleAddTech = async (newTechFromForm)=>{
        if (!userStack) {
            __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$sonner$2f$dist$2f$index$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["toast"].error("Impossible d'ajouter une technologie sans grille.");
            return;
        }
        ...
        if (savedStack) {
            ...
            __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$sonner$2f$dist$2f$index$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["toast"].error("Impossible de sauvegarder la nouvelle technologie, veuillez réessayer.");
        }
    };
    const handleRemoveTech = async (itemIdToRemove, showSuccessToast = true)=>{
        ...
        if (savedStack) {
            ...
            if (showSuccessToast) {
                __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$sonner$2f$dist$2f$index$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["toast"].success("Technology deleted.");
            }
        } else {
            setUserStack(userStack);
    ...
    const handleShowStripeCardInGrid = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useCallback"])(async ()=>{
        if (!userStack) {
            __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$sonner$2f$dist$2f$index$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["toast"].error("Impossible d'ajouter la carte Stripe sans grille.");
            return;
        }
        if (userStack.technologies.find((t)=>t.id === STRIPE_CARD_ID)) {
            __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$sonner$2f$dist$2f$index$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["toast"].info("La carte Stripe est déjà dans la grille.");
            return;
        }
        const newOrder = userStack.technologies.length > 0 ? Math.max(...userStack.technologies.map((t)=>t.order || 0)) + 1 : 0;
        ...
        if (savedStack) {
            setUserStack(savedStack);
            __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$sonner$2f$dist$2f$index$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["toast"].success("Carte Stripe ajoutée à la grille.");
        } else {
            // Revert
            setUserStack(userStack);
            __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$sonner$2f$dist$2f$index$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["toast"].error("Impossible d'ajouter la carte Stripe.");
        }
    }, [
        userStack,
        saveUserStack
...
//# sourceMappingURL=_33bce213._.js.map