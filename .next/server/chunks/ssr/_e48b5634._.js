...
const STRIPE_CARD_DND_ID = "stripe-mrr-card-dnd-id";
const STRIPE_MRR_PSEUDO_TECH_ID = "internal_stripe_mrr_card";
const TRASH_ID = "trash-can-droppable-id";
...
function SortableTechCard({ tech, isPageEditMode, isResizeMode, onRemoveTech, onUpdateTech, gridMax }) {
    ...
    const CardContent = /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
        className: "bento-card p-4 rounded-2xl border border-[--border] flex flex-col items-start backdrop-blur-md relative overflow-hidden group transition-shadow hover:shadow-lg hover:border-[var(--primary)] h-full",
        style: {
            minHeight
        },
        children: [
...
function StripeCard({ id, hasStripeConnection, isConnectingStripe, handleConnectStripe, mrrData, onFetchMrr, isFetchingMrr, handleDisconnectStripe, isDisconnectingStripe, isPageEditMode, isResizeMode, onUpdateStripeCardSize, gridMax, colSpan: currentCardColSpan, rowSpan: currentCardRowSpan }) {
    const { attributes, listeners, setNodeRef, transform, transition, isDragging } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$dnd$2d$kit$2f$sortable$2f$dist$2f$sortable$2e$esm$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useSortable"])({
        id: id,
    ...
    if (currentCardColSpan === 2) {
        colSpanClass = "col-span-1 md:col-span-2";
    } else if (currentCardColSpan === 3) {
        colSpanClass = "col-span-1 md:col-span-2 lg:col-span-3";
    }
    const rowSpanClass = currentCardRowSpan === 2 ? "row-span-2" : "row-span-1";
    const minHeight = currentCardRowSpan * 150 + (currentCardRowSpan - 1) * 16; // 16px gap
    const showResizeControls = isResizeMode && !isPageEditMode;
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
        ref: setNodeRef,
        style: style,
        ...
        children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
            ...
            children: [
                ...
                !showResizeControls && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                    className: "flex-grow flex flex-col w-full overflow-y-auto",
                            ...
                            children: [
                                ...
                                [
                                    ...
                                    3
                                        ...
                                        size: "sm",
                                        variant: currentCardColSpan === c ? "secondary" : "outline",
                                        onClick: (e)=>{
                                            e.stopPropagation();
                                            onUpdateStripeCardSize({
                                                cols: c
                                            });
                                        },
                                        disabled: c > gridMax.cols,
                                        className: "px-2 py-0.5 text-xs h-auto min-w-[24px]",
                                        children: c
                                    }, `stripe-col-${c}`, false, {
                                        fileName: "[project]/app/dashboard/page.tsx",
                            ...
                            children: [
                                ...
                                [
                                    ...
                                    2
                                        ...
                                        size: "sm",
                                        variant: currentCardRowSpan === r ? "secondary" : "outline",
                                        onClick: (e)=>{
                                            e.stopPropagation();
                                            onUpdateStripeCardSize({
                                                rows: r
...
function Dashboard() {
    ...
    const [activeStack, setActiveStack] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useState"])(undefined);
    ...
    const [isAddTechModalOpen, setIsAddTechModalOpen] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useState"])(false);
    ...
    const [stackToDelete, setStackToDelete] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useState"])(null);
    const [itemToRemove, setItemToRemove] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useState"])(null);
    const [showRemoveItemConfirm, setShowRemoveItemConfirm] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useState"])(false);
    // États pour Stripe
    ...
    const [isCheckingStripeConnection, setIsCheckingStripeConnection] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useState"])(true);
    ...
    const [showStripeInGrid, setShowStripeInGrid] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useState"])(false);
    ...
    const [fetchedGitHubStats, setFetchedGitHubStats] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useState"])({});
    const [isStripeSuccessToastShown, setIsStripeSuccessToastShown] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useState"])(false);
    const [stripeCardColSpan, setStripeCardColSpan] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useState"])(2);
    const [stripeCardRowSpan, setStripeCardRowSpan] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useState"])(1);
    const [stripeCardDbId, setStripeCardDbId] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useState"])(null);
    const [gridItemOrder, setGridItemOrder] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useState"])([]);
    ...
    const [showAddStackForm, setShowAddStackForm] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useState"])(false);
    // Dérivation de 'technologies' doit être après la définition de activeStack
    const technologies = activeStack?.technologies || [];
    // --- Définitions de fonctions (useCallback quand nécessaire) ---
    const hydrateTechnologies = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useCallback"])((rawTechs)=>{
        if (!rawTechs) return [];
        return rawTechs.filter((rawTech)=>rawTech.technologyId !== STRIPE_MRR_PSEUDO_TECH_ID).map((rawTech, index)=>{
            let icon;
            let isProject = false;
    ...
    }, []); // iconMap et getDefaultIcon sont stables et définies hors du composant
    const saveActiveStack = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useCallback"])(async (stackToSave, showSuccessToast = true)=>{
        if (!session?.user?.id) {
            /* ... */ return null;
        }
        if (!stackToSave) {
        ...
        const itemsToSave = [];
        gridItemOrder.forEach((itemId, index)=>{
            if (itemId === STRIPE_CARD_DND_ID) {
                if (showStripeInGrid) {
                    itemsToSave.push({
                        id: stripeCardDbId,
                        name: "Stripe MRR",
                        color: "#635BFF",
                        technologyId: STRIPE_MRR_PSEUDO_TECH_ID,
                        category: "Services",
                        gridCols: stripeCardColSpan,
                        gridRows: stripeCardRowSpan,
                        isProject: false,
                        order: index
                    });
                }
            } else {
                const tech = stackToSave.technologies.find((t)=>String(t.id) === String(itemId));
                if (tech) {
                    itemsToSave.push({
                        /* ... tech props ... */ order: index,
                        id: tech.id,
                        name: tech.name,
                        color: tech.color,
        ...
        try {
            ...
            const stripeItemFromApi = (savedStackData.technologies || []).find((t)=>t.technologyId === STRIPE_MRR_PSEUDO_TECH_ID);
            const regularTechsFromApi = (savedStackData.technologies || []).filter((t)=>t.technologyId !== STRIPE_MRR_PSEUDO_TECH_ID);
            if (stripeItemFromApi) {
                setShowStripeInGrid(true);
                setStripeCardDbId(String(stripeItemFromApi.id));
                setStripeCardColSpan(stripeItemFromApi.gridCols || 2);
                setStripeCardRowSpan(stripeItemFromApi.gridRows || 1);
            } else {
                setShowStripeInGrid(false);
                setStripeCardDbId(null);
            }
            const hydratedTechs = hydrateTechnologies(regularTechsFromApi);
            const finalStack = {
                ...savedStackData,
                technologies: hydratedTechs
            };
            setUserStacks((prevStacks)=>prevStacks.map((s)=>s.id === finalStack.id ? finalStack : s));
            if (activeStackId === null && finalStack.id) setActiveStackId(finalStack.id);
            if (showSuccessToast) __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$sonner$2f$dist$2f$index$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["toast"].success(`Stack '${finalStack.name}' saved successfully!`);
            return finalStack;
        } catch (error) {
            /* ... */ return null;
        }
    ...
    const handleShowStripeCardInGrid = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useCallback"])(()=>{
        if (!hasStripeConnection) {
            handleConnectStripe();
            return;
        }
        setShowStripeInGrid(true);
        setGridItemOrder((prevOrder)=>prevOrder.includes(STRIPE_CARD_DND_ID) ? prevOrder : [
                STRIPE_CARD_DND_ID,
                ...prevOrder.filter((id)=>id !== STRIPE_CARD_DND_ID)
            ]);
        if (activeStack) {
            saveActiveStack({
                ...activeStack,
        ...
        activeStack,
        saveActiveStack
    ]); // handleConnectStripe est stable
    const handleFetchStripeAccountMrr = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useCallback"])(async ()=>{
        ...
        try {
            ...
            __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$sonner$2f$dist$2f$index$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["toast"].success("Stripe MRR data fetched successfully!");
        } catch (error) {
    ...
    }, []); // Pas de dépendances externes dynamiques
    const handleDisconnectStripe = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useCallback"])(async ()=>{
        ...
        try {
            ...
            __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$sonner$2f$dist$2f$index$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["toast"].success("Compte Stripe déconnecté avec succès.");
            setHasStripeConnection(false);
            setStripeAccountMrr(null);
            setShowStripeInGrid(false);
            setStripeCardDbId(null);
            setGridItemOrder((prevOrder)=>prevOrder.filter((id)=>id !== STRIPE_CARD_DND_ID));
            if (activeStack && stripeCardDbId) {
                saveActiveStack({
                    ...activeStack,
                    technologies: [
                        ...activeStack.technologies
            ...
            /* ... */ __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$sonner$2f$dist$2f$index$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["toast"].error(error.message || "Impossible de déconnecter le compte Stripe.");
        } finally{
    ...
    const handleUpdateStripeCardSize = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useCallback"])((updates)=>{
        let changed = false;
        if (updates.cols && stripeCardColSpan !== updates.cols) {
            setStripeCardColSpan(updates.cols);
            changed = true;
        }
        if (updates.rows && stripeCardRowSpan !== updates.rows) {
            setStripeCardRowSpan(updates.rows);
            changed = true;
        }
        if (changed && activeStack && showStripeInGrid) {
            saveActiveStack({
                ...activeStack,
                technologies: [
                    ...activeStack.technologies
    ...
    const handleUpdateTech = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useCallback"])((id, updates)=>{
        ...
        if (typeof updates.stars !== "undefined" || typeof updates.forks !== "undefined" || typeof updates.description !== "undefined" || typeof updates.gridSpan !== "undefined") {
    ...
    const handleRemoveTech = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useCallback"])(async (stackTechnologyItemId)=>{
        if (!activeStack) return;
        // La suppression de la carte Stripe est gérée par handleDisconnectStripe
        if (stackTechnologyItemId === STRIPE_CARD_DND_ID) return;
        try {
            ...
            setUserStacks((prevStacks)=>prevStacks.map((s)=>s.id === activeStackId ? updatedStack : s));
            setGridItemOrder((prev)=>prev.filter((id)=>id !== stackTechnologyItemId)); // Mettre à jour aussi gridItemOrder
        ...
        // Pas besoin de saveActiveStack ici car l'API delete s'en est chargé.
        // Il faudrait potentiellement re-fetch le stack ou s'assurer que l'état est cohérent.
        // Pour l'instant, on se fie à la mise à jour locale.
        } catch (error) {
    ...
    // --- useEffects --- (Doivent venir APRES les définitions de fonctions qu'ils utilisent)
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useEffect"])(()=>{
        if (activeStackId !== null && userStacks.length > 0) {
            const currentActiveStack = userStacks.find((stack)=>stack.id === activeStackId);
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useEffect"])(()=>{
        ...
        // ... (logique pour stripeSuccess et stripeError, appelant handleShowStripeCardInGrid si besoin)
        if (stripeSuccess && !isStripeSuccessToastShown) {
            ...
            setIsStripeSuccessToastShown(true);
        // ... (nettoyage URL)
        }
    // ... (checkStripeStatus)
    }, [
        ...
        session,
        isLoadingSession,
        isStripeSuccessToastShown,
        handleShowStripeCardInGrid
    ]);
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useEffect"])(()=>{
        if (activeStack) {
            const techIds = activeStack.technologies.map((t)=>String(t.id));
            let newOrder = [
                ...techIds
            ]; // Initialiser avec les technos actuelles
            // Lire l'ordre persisté du stack, qui inclut la carte Stripe et son ordre si elle existe
            const persistedOrderMap = new Map();
            activeStack.technologies.forEach((t)=>{
                if (t.order !== undefined) persistedOrderMap.set(String(t.id), t.order);
            });
            // Si la carte Stripe a un ordre persisté (via son pseudo-item en DB)
            const stripeTechFromStack = activeStack.technologies.find((t)=>t.technologyId === STRIPE_MRR_PSEUDO_TECH_ID);
            if (stripeTechFromStack && stripeTechFromStack.order !== undefined) {
                persistedOrderMap.set(STRIPE_CARD_DND_ID, stripeTechFromStack.order);
            }
            // Construire newOrder en respectant l'ordre persisté
            const allPossibleItems = showStripeInGrid ? [
                STRIPE_CARD_DND_ID,
                ...techIds
            ] : [
                ...techIds
            ];
            const uniqueItems = Array.from(new Set(allPossibleItems)); // Assurer l'unicité
            newOrder = uniqueItems.sort((a, b)=>{
                const orderA = persistedOrderMap.get(a);
                const orderB = persistedOrderMap.get(b);
                if (orderA !== undefined && orderB !== undefined) return orderA - orderB;
                if (orderA !== undefined) return -1; // Mettre ceux avec ordre en premier
                if (orderB !== undefined) return 1;
                return 0; // Garder l'ordre relatif pour ceux sans ordre explicite
            });
            // Si showStripeInGrid est vrai mais que STRIPE_CARD_DND_ID n'est pas dans newOrder (ex: nouveau), l'ajouter (début par défaut)
            if (showStripeInGrid && !newOrder.includes(STRIPE_CARD_DND_ID)) {
                newOrder.unshift(STRIPE_CARD_DND_ID);
            }
            // Si showStripeInGrid est faux, s'assurer que STRIPE_CARD_DND_ID est retiré
            if (!showStripeInGrid) {
                newOrder = newOrder.filter((id)=>id !== STRIPE_CARD_DND_ID);
            }
            if (JSON.stringify(newOrder) !== JSON.stringify(gridItemOrder)) {
                setGridItemOrder(newOrder);
            }
        } else {
            setGridItemOrder(showStripeInGrid ? [
                STRIPE_CARD_DND_ID
            ] : []);
        }
    }, [
        ...
        showStripeInGrid,
        gridItemOrder
    ]); // gridItemOrder ajouté comme dépendance pour réévaluer si besoin
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useEffect"])(()=>{
        if (session?.user) {
    ...
    // useEffect pour fetcher le MRR (après que handleFetchStripeAccountMrr soit défini)
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useEffect"])(()=>{
        if (showStripeInGrid && hasStripeConnection && !stripeAccountMrr && !isLoadingStripeAccountMrr) {
    ...
    // useEffect pour fetcher les stats GitHub (après que handleUpdateTech soit défini)
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useEffect"])(()=>{
        if (initialDataLoaded && activeStack && activeStack.technologies.length > 0) {
            activeStack.technologies.forEach((tech)=>{
                if (tech.isProject && tech.url && tech.url.startsWith("https://github.com/") && !fetchedGitHubStats[tech.id]) {
                // ... (logique de fetchStats appelant handleUpdateTech)
                }
            });
        }
    }, [
    ...
    // useEffect pour charger les stacks (après que hydrateTechnologies soit défini)
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useEffect"])(()=>{
        const fetchUserStacks = async ()=>{
            if (session?.user?.id) {
                ...
                try {
                    ...
                    let stacksData = await response.json();
                    const hydratedStacks = stacksData.map((stack)=>{
                        const stripeItemInStack = (stack.technologies || []).find((tech)=>tech.technologyId === STRIPE_MRR_PSEUDO_TECH_ID);
                        const regularTechs = (stack.technologies || []).filter((tech)=>tech.technologyId !== STRIPE_MRR_PSEUDO_TECH_ID);
                        // Mettre à jour l'état pour la carte Stripe si c'est le stack actif initialement
                        if (stripeItemInStack && (activeStackId === null && stack.id === stacksData[0]?.id || stack.id === activeStackId)) {
                            setShowStripeInGrid(true);
                            setStripeCardDbId(String(stripeItemInStack.id));
                            setStripeCardColSpan(stripeItemInStack.gridCols || 2);
                            setStripeCardRowSpan(stripeItemInStack.gridRows || 1);
                        } else if (!stripeItemInStack && (activeStackId === null && stack.id === stacksData[0]?.id || stack.id === activeStackId)) {
                            setShowStripeInGrid(false);
                            setStripeCardDbId(null);
                        }
                        return {
                            ...stack,
                            technologies: hydrateTechnologies(regularTechs)
                        };
                    });
        ...
        if (!isLoadingSession) fetchUserStacks();
    }, [
        session,
        isLoadingSession,
        hydrateTechnologies,
        activeStackId
    ]); // activeStackId est important ici
    const sensors = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$dnd$2d$kit$2f$core$2f$dist$2f$core$2e$esm$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useSensors"])();
    const handleDragEnd = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useCallback"])((event)=>{
        ...
        if (over && over.id === TRASH_ID) {
            ...
            if (activeId === STRIPE_CARD_DND_ID) {
                handleDisconnectStripe();
            } else {
                handleRemoveTech(activeId);
            }
            return;
        }
        if (over && active.id !== over.id) {
            const oldIndex = gridItemOrder.indexOf(active.id);
            const newIndex = gridItemOrder.indexOf(over.id);
            if (oldIndex !== -1 && newIndex !== -1) {
                const newOrderedGridItems = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$dnd$2d$kit$2f$sortable$2f$dist$2f$sortable$2e$esm$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["arrayMove"])(gridItemOrder, oldIndex, newIndex);
                setGridItemOrder(newOrderedGridItems);
                if (activeStack) {
                    saveActiveStack({
                        ...activeStack,
                        technologies: [
    ...
    // ... (autres handlers comme handleCreateNewStack, handleDeleteStack, etc. qui peuvent utiliser saveActiveStack)
    // Définir handleAddTech, handleActiveStackNameChange, handleProfileDescriptionChange ici
    const handleAddTech = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useCallback"])(async (newTechFromForm)=>{
        if (!activeStack) {
            /* ... */ return;
        }
        ...
        // Mettre à jour userStacks avec le stack sauvegardé si nécessaire pour avoir les bons IDs
        if (savedStack) {
    ...
    const handleReorderTechs = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useCallback"])((reorderedTechs)=>{
        if (!activeStack) return;
        const updatedStack = {
            ...activeStack,
    ...
    // ... (ProfileHeader, StacksSelector, BentoGridSection - s'assurer qu'ils reçoivent les fonctions mémorisées)
    // Le return du composant Dashboard
    ...
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["Fragment"], {
        children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])(BentoGridSection, {
            // ... passer toutes les props nécessaires, y compris les fonctions mémorisées
            ...
            showStripeInGrid: showStripeInGrid,
            stripeCardColSpan: stripeCardColSpan,
            stripeCardRowSpan: stripeCardRowSpan,
            handleUpdateStripeCardSize: handleUpdateStripeCardSize
        }, void 0, false, {
            fileName: "[project]/app/dashboard/page.tsx",
            lineNumber: 1199,
            columnNumber: 7
...
//# sourceMappingURL=_e48b5634._.js.map